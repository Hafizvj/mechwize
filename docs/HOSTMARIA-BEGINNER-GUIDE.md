...
- [x] Hostmaria hosting account login (cPanel)
- [x] Domain `mechwize.com` pointed to Hostmaria (or ready to point)
- [x] GitHub account access to: [https://github.com/Hafizvj/mechwize](https://github.com/Hafizvj/mechwize)
- [x] A computer with internet
- [x] About 30–60 minutes

Useful links:

- Website repo: [https://github.com/Hafizvj/mechwize](https://github.com/Hafizvj/mechwize)
- Pull request / latest work branch: [https://github.com/Hafizvj/mechwize/pull/1](https://github.com/Hafizvj/mechwize/pull/1)
...
1. Open: [https://github.com/Hafizvj/mechwize](https://github.com/Hafizvj/mechwize)
...
- [https://mechwize.com](https://mechwize.com)
...
- [https://mechwize.com/admin/login.php](https://mechwize.com/admin/login.php)
...
1. Open [https://mechwize.com/contact](https://mechwize.com/contact)
...
| `uploads/` writable                                     | ☐     |
| [https://mechwize.com](https://mechwize.com) opens      | ☐     |
| Admin login works                                       | ☐     |
